    ...
    <v-container>
      ...
      <div class="header-section mb-6">
        <div class="d-flex justify-space-between align-center mb-4">
          <div>
            <h1 class="text-h4 font-weight-bold mb-2">Nouveau Produit</h1>
            <p class="text-body-1 text-medium-emphasis">
              Créez un nouveau produit pour votre boutique e-commerce
            </p>
          </div>
          <v-btn
            color="grey"
        ...
        >
          <v-card-title class="section-header d-flex align-center">
            ...
            <div class="flex-grow-1">
              ...
              <p class="section-subtitle">Configurez les attributs et créez les variantes</p>
            </div>
            <div class="section-status">
              <v-chip 
                v-if="!isBasicInfoComplete" 
            ...
            <v-card-text v-show="currentStep === 2 && isBasicInfoComplete">
              ...
              <div class="attributes-section mb-6">
                ...
                <v-alert type="info" variant="tonal" class="mb-4">
                  ...
                  Vous pourrez ajouter de nouvelles valeurs lors de la création des variantes.
                </v-alert>
              ...
              <!-- Section variantes -->
              <div v-if="selectedAttributes.length > 0" class="variants-section">
                <div class="d-flex justify-space-between align-center mb-4">
                    ...
                    <v-card variant="outlined" class="pa-4">
                      ...
                      <v-row>
                        ...
                        <v-col cols="12" md="8">
                          ...
                          <div v-if="variantImagePreviews[index]" class="mt-3">
        ...
        >
          <v-card-title class="section-header d-flex align-center">
            ...
            <div class="flex-grow-1">
              ...
              <p class="section-subtitle">Vérifiez et créez votre produit</p>
            </div>
          </v-card-title>
          ...
          <v-expand-transition>
            <v-card-text v-show="currentStep === 3 && isBasicInfoComplete">
              ...
              <div class="product-summary mb-6">
                <h4 class="text-h6 mb-4">Résumé du produit</h4>
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="6">
                    <v-card variant="outlined" class="pa-4">
                      ...
                      <div class="summary-item">
                        <span class="summary-label">Variantes créées :</span>
...
const createProduct = async () => {
  ...
  try {
    ...
    // Utiliser le store pour créer le produit
    await productStore.storeProduct(null, formData)
